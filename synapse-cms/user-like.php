...
<?php
	...
	if(isset($user)) {
		...
		echo("<div class=\"likeBox\"><div class=\"like\"><span>".$obj->info_howmany_friendships($user)."</span><a href=\"index.php\" class=\"liketxt\"><b>Friends by ".$user."</b></a></div></div>");
    } else echo("--");
?>
	</center>
